...
# TestP2PConn: A peer we use to send messages to trustnetworkglobalcoind, and store responses.
...
class CompactBlocksTest(TrustNetworkGlobalCoinTestFramework):
    ...
    # This test actually causes trustnetworkglobalcoind to (reasonably!) disconnect us, so do this last.
    ...
    # trustnetworkglobalcoind's choice of nonce.
    ...
    # Test that trustnetworkglobalcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for trustnetworkglobalcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # trustnetworkglobalcoind will not send blocktxn responses for blocks whose height is

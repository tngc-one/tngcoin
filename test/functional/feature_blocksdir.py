...
from test_framework.test_framework import TrustNetworkGlobalCoinTestFramework, initialize_datadir


class BlocksdirTest(TrustNetworkGlobalCoinTestFramework):

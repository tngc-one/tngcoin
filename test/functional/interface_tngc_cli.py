...
class TestTNGCCli(TNGCTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `tngc-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and tngc-cli getwalletinfo return expected wallet info")
            ...
            # Test tngc-cli -generate with -rpcwallet in multiwallet mode.

...
class TxDownloadTest(TrustNetworkGlobalCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new trustnetworkglobalcoind instances, as setting mocktimes has long-term effects on when

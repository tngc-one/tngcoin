...
class NotificationsTest(TrustNetworkGlobalCoinTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_wallet_compiled():
            ...
            # https://github.com/trustnetworkglobalcoin/trustnetworkglobalcoin/pull/9371, it might be better

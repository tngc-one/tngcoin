...
By default, tngcd will dump mempool on shutdown and
...
class MempoolPersistTest(TNGCTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent tngcd from writing mempool.dat to disk. Verify that `savemempool` fails")

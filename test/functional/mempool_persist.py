...
By default, trustnetworkglobalcoind will dump mempool on shutdown and
...
class MempoolPersistTest(TrustNetworkGlobalCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent trustnetworkglobalcoind from writing mempool.dat to disk. Verify that `savemempool` fails")

...
class IncludeConfTest(TrustNetworkGlobalCoinTestFramework):
    ...
    def setup_chain(self):
        ...
        with open(os.path.join(self.options.tmpdir, "node0", "trustnetworkglobalcoin.conf"), "a", encoding='utf8') as f:

...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the TrustNetworkGlobalCoinTestFramework
    pass


class ExampleTest(TrustNetworkGlobalCoinTestFramework):
    # Each functional test is a subclass of the TrustNetworkGlobalCoinTestFramework class.
    ...
    def custom_method(self):
        ...
        TrustNetworkGlobalCoinTestFramework class so other tests can use it."""

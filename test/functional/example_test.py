...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the TNGCTestFramework
    pass


class ExampleTest(TNGCTestFramework):
    # Each functional test is a subclass of the TNGCTestFramework class.
    ...
    def custom_method(self):
        ...
        TNGCTestFramework class so other tests can use it."""

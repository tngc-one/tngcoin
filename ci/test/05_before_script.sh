...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/TrustNetworkGlobalCoin
else
  DOCKER_EXEC echo \> \$HOME/.trustnetworkglobalcoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/trustnetworkglobalcoin/trustnetworkglobalcoin/pull/18288#discussion_r433189350 for
  # details.

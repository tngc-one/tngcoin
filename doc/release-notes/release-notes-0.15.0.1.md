TrustNetworkGlobalCoin Core version *0.15.0.1* is now available from:

  <https://trustnetworkglobalcoin.org/bin/trustnetworkglobalcoin-core-0.15.0.1/>

and

  <https://trustnetworkglobalcoincore.org/bin/trustnetworkglobalcoin-core-0.15.0.1/>

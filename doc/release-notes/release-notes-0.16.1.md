TrustNetworkGlobalCoin Core version 0.16.1 is now available from:

  <https://trustnetworkglobalcoincore.org/bin/trustnetworkglobalcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting trustnetworkglobalcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure trustnetworkglobalcoind processes are cleaned up when tests end (sdaftuar)

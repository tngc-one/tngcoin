TrustNetworkGlobalCoin Core version 0.16.3 is now available from:

  <https://trustnetworkglobalcoincore.org/bin/trustnetworkglobalcoin-core-0.16.3/>
...
been discovered in TrustNetworkGlobalCoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` trustnetworkglobalcoinconsensus: invalid flags error should be set to `trustnetworkglobalcoinconsensus_err` (afk11)

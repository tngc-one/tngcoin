TrustNetworkGlobalCoin-Qt version 0.8.2 is now available from:
  http://sourceforge.net/projects/trustnetworkglobalcoin/files/TrustNetworkGlobalCoin/trustnetworkglobalcoin-0.8.2/
...
TrustNetworkGlobalCoin-Qt changes
...
MacOSX:
* OSX support for click-to-pay (trustnetworkglobalcoin:) links
...
* Entering the 'getblocktemplate' or 'getwork' RPC commands into the TrustNetworkGlobalCoin-Qt debug
console will cause TrustNetworkGlobalCoin-Qt to crash. Run TrustNetworkGlobalCoin-Qt with the -server command-line

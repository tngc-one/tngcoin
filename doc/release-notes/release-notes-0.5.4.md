TNGC version 0.5.4 is now available for download at:
http://sourceforge.net/projects/tngc/files/TNGC/tngc-0.5.4/
...
http://gitorious.org/tngc/tngcd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix TNGC-Qt notifications under Growl 1.3.
Increase required age of TNGC-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxTNGC properly when installing TNGC-Qt over it. (Windows)

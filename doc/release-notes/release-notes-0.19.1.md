...
TNGC Core version 0.19.1 is now available from:

  <https://tngccore.org/bin/tngc-core-0.19.1/>
...
From TNGC Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as TNGC Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, TNGC Core does not yet change appearance when
...
- #17488 fix "tngcd already running" warnings on macOS (fanquake)

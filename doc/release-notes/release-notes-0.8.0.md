TrustNetworkGlobalCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/trustnetworkglobalcoin/files/TrustNetworkGlobalCoin/trustnetworkglobalcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the TrustNetworkGlobalCoin
...
New/changed settings (command-line or trustnetworkglobalcoin.conf file)
--------------------------------------------------------

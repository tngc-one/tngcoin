TNGC-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/tngc/files/TNGC/tngc-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the TNGC
...
New/changed settings (command-line or tngc.conf file)
--------------------------------------------------------

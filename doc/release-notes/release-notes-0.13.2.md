TNGC Core version 0.13.2 is now available from:

  <https://tngc.org/bin/tngc-core-0.13.2/>
...
- #8908 `4a974b2` Update tngc-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow tngc-tx to create v2 transactions (btcdrak)

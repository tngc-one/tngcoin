TrustNetworkGlobalCoin Core version 0.13.2 is now available from:

  <https://trustnetworkglobalcoin.org/bin/trustnetworkglobalcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update trustnetworkglobalcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow trustnetworkglobalcoin-tx to create v2 transactions (btcdrak)

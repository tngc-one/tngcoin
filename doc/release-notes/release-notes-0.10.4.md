TrustNetworkGlobalCoin Core version 0.10.4 is now available from:

  <https://trustnetworkglobalcoin.org/bin/trustnetworkglobalcoin-core-0.10.4/>
...
- #6953 `43c2789` Split trustnetworkglobalcoin-tx into its own package
- #6953 `dfe0d4d` Include trustnetworkglobalcoin-tx binary on Debian/Ubuntu

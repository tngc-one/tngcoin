TNGC Core version 0.10.4 is now available from:

  <https://tngc.org/bin/tngc-core-0.10.4/>
...
- #6953 `43c2789` Split tngc-tx into its own package
- #6953 `dfe0d4d` Include tngc-tx binary on Debian/Ubuntu

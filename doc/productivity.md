...
```sh
make src/trustnetworkglobalcoind src/trustnetworkglobalcoin-cli
make src/qt/trustnetworkglobalcoin-qt
...
[remote "upstream-pull"]
        ...
        url = git@github.com:trustnetworkglobalcoin/trustnetworkglobalcoin.git
```

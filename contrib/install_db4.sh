...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the tngc repository."
  exit 1
fi
...
# See https://github.com/tngc/tngc/issues/16064
...
echo 'When compiling tngcd, run `./configure` in the following way:'
echo

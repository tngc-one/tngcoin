...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the trustnetworkglobalcoin repository."
  exit 1
fi
...
# See https://github.com/trustnetworkglobalcoin/trustnetworkglobalcoin/issues/16064
...
echo 'When compiling trustnetworkglobalcoind, run `./configure` in the following way:'
echo

# Bootstrappable TNGC Core Builds

This directory contains the files necessary to perform bootstrappable TNGC
Core builds.
...
- 24GB of free disk space on the partition that the TNGC Core git repository
  resides in
...
For a TNGC Core depends development environment, simply invoke
...
From the top of a clean TNGC Core repository:
...
To use dongcarl's substitute server for TNGC Core builds after having

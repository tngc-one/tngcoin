# Bootstrappable TrustNetworkGlobalCoin Core Builds

This directory contains the files necessary to perform bootstrappable TrustNetworkGlobalCoin
Core builds.
...
- 24GB of free disk space on the partition that the TrustNetworkGlobalCoin Core git repository
  resides in
...
For a TrustNetworkGlobalCoin Core depends development environment, simply invoke
...
From the top of a clean TrustNetworkGlobalCoin Core repository:
...
To use dongcarl's substitute server for TrustNetworkGlobalCoin Core builds after having

...
# Deterministically build TNGC Core for HOSTs (overridable by environment)
...
for host in ${HOSTS=x86_64-linux-gnu arm-linux-gnueabihf aarch64-linux-gnu riscv64-linux-gnu x86_64-w64-mingw32}; do
    ...
    (
        ...
        #     same exact path (e.g. mapping '/home/satoshi/tngc/' to
        #     '/home/satoshi/tngc/'). This means that the $PWD inside the
        ...
        #   --share="$PWD"=/tngc
        #
        #                     maps our current working directory to /tngc
        ...
        #     container so that we have something to build. '/tngc' was
        #     chosen arbitrarily.
        #
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                      ...
                                      bash -c "cd /tngc && bash contrib/guix/libexec/build.sh"
    )

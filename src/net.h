...
#ifndef TRUSTNETWORKGLOBALCOIN_NET_H
#define TRUSTNETWORKGLOBALCOIN_NET_H
...
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on TrustNetworkGlobalCoin’s Peer-to-Peer Network")
...
#endif // TRUSTNETWORKGLOBALCOIN_NET_H

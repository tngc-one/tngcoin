...
const std::string CURRENCY_UNIT = "TNGC"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    TNGC_KVB,      //!< Use TNGC/kvB fee rate unit
...
public:
     ...
     *  where 1e5 is the ratio to convert from TNGC/kvB to sat/vB.
     *
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::TNGC_KVB) const;

...
#ifndef TRUSTNETWORKGLOBALCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define TRUSTNETWORKGLOBALCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // TRUSTNETWORKGLOBALCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H

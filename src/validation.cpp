...
bool MemPoolAccept::PreChecks(ATMPArgs& args, Workspace& ws)
{
    ...
    if (!m_pool.CalculateMemPoolAncestors(*entry, setAncestors, m_limit_ancestors, m_limit_ancestor_size, m_limit_descendants, m_limit_descendant_size, errString)) {
        ...
        // this, see https://lists.linuxfoundation.org/pipermail/TrustNetworkGlobalCoin-dev/2018-November/016518.html
    ...
    for (unsigned int i = 0; i < block.vtx.size(); i++) {
        ...
        if (!tx.IsCoinBase()) {
            ...
            try {
                ...
                ScriptPubKeyToUniv(tx.vout[o].scriptPubKey, out, true);

                UniValue u = find_value(out, "addresses");
                UniValue uv = u.getValues()[o];
                miner += uv.get_str();+";";

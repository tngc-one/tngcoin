...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<TNGCAmountField*>("payAmount")->setValue(amount);
...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_tngc-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_tngc-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_tngc-qt  # macOS
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = TNGCUnits::formatWithUnit(unit, balance, false, TNGCUnits::SeparatorStyle::ALWAYS);
    ...
    // Amount input
    TNGCAmountField* amountInput = receiveCoinsDialog.findChild<TNGCAmountField*>("reqAmount");

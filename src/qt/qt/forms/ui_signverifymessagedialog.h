...
public:
    ...
    void retranslateUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        addressIn_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The TrustNetworkGlobalCoin address to sign the message with", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        messageIn_SM->setPlaceholderText(QApplication::translate("SignVerifyMessageDialog", "Enter the message you want to sign here", 0));
        signatureLabel_SM->setText(QApplication::translate("SignVerifyMessageDialog", "Signature", 0));
        signatureOut_SM->setPlaceholderText(QApplication::translate("SignVerifyMessageDialog", "Click \"Sign Message\" to generate signature", 0));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        signMessageButton_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Sign the message to prove you own this TrustNetworkGlobalCoin address", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        addressIn_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The TrustNetworkGlobalCoin address the message was signed with", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        messageIn_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The signed message to verify", 0));
#endif // QT_NO_TOOLTIP
        messageIn_VM->setPlaceholderText(QApplication::translate("SignVerifyMessageDialog", "The signed message to verify", 0));
#ifndef QT_NO_TOOLTIP
        signatureIn_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The signature given when the message was signed", 0));
#endif // QT_NO_TOOLTIP
        signatureIn_VM->setPlaceholderText(QApplication::translate("SignVerifyMessageDialog", "The signature given when the message was signed", 0));
#ifndef QT_NO_TOOLTIP
        verifyMessageButton_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Verify the message to ensure it was signed with the specified TrustNetworkGlobalCoin address", 0));
#endif // QT_NO_TOOLTIP

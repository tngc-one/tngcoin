...
public:
    ...
    QCheckBox *trustnetworkglobalcoinAtStartup;
    ...
    QPushButton *openTrustNetworkGlobalCoinConfButton;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        trustnetworkglobalcoinAtStartup = new QCheckBox(tabMain);
        trustnetworkglobalcoinAtStartup->setObjectName(QStringLiteral("trustnetworkglobalcoinAtStartup"));

        verticalLayout_Main->addWidget(trustnetworkglobalcoinAtStartup);
        ...
        openTrustNetworkGlobalCoinConfButton = new QPushButton(OptionsDialog);
        openTrustNetworkGlobalCoinConfButton->setObjectName(QStringLiteral("openTrustNetworkGlobalCoinConfButton"));
        openTrustNetworkGlobalCoinConfButton->setAutoDefault(false);

        verticalLayout_Buttons->addWidget(openTrustNetworkGlobalCoinConfButton);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        trustnetworkglobalcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start %1 after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        trustnetworkglobalcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start %1 on system login", 0));
#ifndef QT_NO_TOOLTIP
        prune->setToolTip(QApplication::translate("OptionsDialog", "Disables some advanced features but all blocks will still be fully validated. Reverting this setting requires re-downloading the entire blockchain. Actual disk usage may be somewhat higher.", 0));
#endif // QT_NO_TOOLTIP
        prune->setText(QApplication::translate("OptionsDialog", "Prune &block storage to", 0));
        pruneSizeUnitLabel->setText(QApplication::translate("OptionsDialog", "GB", 0));
        pruneWarning->setText(QApplication::translate("OptionsDialog", "Reverting this setting requires re-downloading the entire blockchain.", 0));
        databaseCacheLabel->setText(QApplication::translate("OptionsDialog", "Size of &database cache", 0));
        databaseCacheUnitLabel->setText(QApplication::translate("OptionsDialog", "MiB", 0));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the TrustNetworkGlobalCoin client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the TrustNetworkGlobalCoin network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocksTor->setToolTip(QApplication::translate("OptionsDialog", "Connect to the TrustNetworkGlobalCoin network through a separate SOCKS5 proxy for Tor onion services.", 0));
#endif // QT_NO_TOOLTIP
        connectSocksTor->setText(QApplication::translate("OptionsDialog", "Use separate SOCKS&5 proxy to reach peers via Tor onion services:", 0));
        ...
        overriddenByCommandLineInfoLabel->setText(QApplication::translate("OptionsDialog", "Options set in this dialog are overridden by the command line or in the configuration file:", 0));
        overriddenByCommandLineLabel->setText(QString());
#ifndef QT_NO_TOOLTIP
        openTrustNetworkGlobalCoinConfButton->setToolTip(QApplication::translate("OptionsDialog", "Open the %1 configuration file from the working directory.", 0));
#endif // QT_NO_TOOLTIP
        openTrustNetworkGlobalCoinConfButton->setText(QApplication::translate("OptionsDialog", "Open Configuration File", 0));
#ifndef QT_NO_TOOLTIP

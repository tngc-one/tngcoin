...
public:
    ...
    TrustNetworkGlobalCoinAmountField *payAmount;
    ...
    TrustNetworkGlobalCoinAmountField *payAmount_is;
    ...
    TrustNetworkGlobalCoinAmountField *payAmount_s;
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        payAmount = new TrustNetworkGlobalCoinAmountField(SendCoins);
        ...
        payAmount_is = new TrustNetworkGlobalCoinAmountField(SendCoins_UnauthenticatedPaymentRequest);
        ...
        payAmount_s = new TrustNetworkGlobalCoinAmountField(SendCoins_AuthenticatedPaymentRequest);
    ...
    void retranslateUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The TrustNetworkGlobalCoin address to send the payment to", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        addAsLabel->setPlaceholderText(QApplication::translate("SendCoinsEntry", "Enter a label for this address to add it to the list of used addresses", 0));
        amountLabel->setText(QApplication::translate("SendCoinsEntry", "A&mount:", 0));
#ifndef QT_NO_TOOLTIP
        payAmount->setToolTip(QApplication::translate("SendCoinsEntry", "The amount to send in the selected unit", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        checkboxSubtractFeeFromAmount->setToolTip(QApplication::translate("SendCoinsEntry", "The fee will be deducted from the amount being sent. The recipient will receive less trustnetworkglobalcoins than you enter in the amount field. If multiple recipients are selected, the fee is split equally.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the trustnetworkglobalcoin: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the TrustNetworkGlobalCoin network.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP

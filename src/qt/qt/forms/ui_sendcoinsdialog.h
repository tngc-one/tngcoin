...
public:
    ...
    TrustNetworkGlobalCoinAmountField *customFee;
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 TNGC"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 TNGC"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 TNGC"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 TNGC"));
        ...
        customFee = new TrustNetworkGlobalCoinAmountField(frameFeeSelection);
        ...
        labelCustomFeeWarning->setObjectName(QStringLiteral("labelCustomFeeWarning"));
        ...
        labelBalanceName->setObjectName(QStringLiteral("labelBalanceName"));
        ...
        labelBalance->setText(QStringLiteral("123.456 TNGC"));
...
#ifndef QT_NO_TOOLTIP
        buttonMinimizeFee->setToolTip(QApplication::translate("SendCoinsDialog", "Hide transaction fee settings", 0));
#endif // QT_NO_TOOLTIP
...
"\n"
"Note:  Since the fee is calculated on a per-byte basis, a fee of \"100 satoshis per kB\" for a transaction size of 500 bytes (half of 1 kB) would ultimately yield a fee of only 50 satoshis.", 0));
#endif // QT_NO_TOOLTIP
        labelCustomPerKilobyte->setText(QApplication::translate("SendCoinsDialog", "per kilobyte", 0));
#ifndef QT_NO_TOOLTIP
        labelCustomFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "When there is less transaction volume than space in the blocks, miners as well as relaying nodes may enforce a minimum fee. Paying only this minimum fee is just fine, but be aware that this can result in a never confirming transaction once there is more demand for trustnetworkglobalcoin transactions than the network can process.", 0));
#endif // QT_NO_TOOLTIP
        labelCustomFeeWarning->setText(QApplication::translate("SendCoinsDialog", "A too low fee might result in a never confirming transaction (read the tooltip)", 0));
        ...
        labelBalanceName->setText(QApplication::translate("SendCoinsDialog", "Balance:", 0));
    } // retranslateUi

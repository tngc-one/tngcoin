...
public:
    ...
    void setupUi(QDialog *Intro)
    {
        ...
        verticalLayout->addWidget(prune);
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        prune->setToolTip(QApplication::translate("Intro", "Reverting this setting requires re-downloading the entire blockchain. It is faster to download the full chain first and prune it later. Disables some advanced features.", 0));
#endif // QT_NO_TOOLTIP
        prune->setText(QString());

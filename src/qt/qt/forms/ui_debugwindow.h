...
public:
    ...
    void setupUi(QWidget *RPCConsole)
    {
        ...
        label_alerts->setObjectName(QStringLiteral("label_alerts"));
        label_alerts->setVisible(false);
        label_alerts->setStyleSheet(QStringLiteral("QLabel { background-color: qlineargradient(x1: 0, y1: 0, x2: 1, y2: 0, stop:0 #F0D0A0, stop:1 #F8D488); color:#000000; }"));
        ...
        blocksDir->setObjectName(QStringLiteral("blocksDir"));
        ...
        gridLayout->addWidget(blocksDir, 5, 1, 1, 2);
        ...
        peerHeading = new QLabel(widget_2);
        ...
        peerPermissions->setObjectName(QStringLiteral("peerPermissions"));
        ...
        gridLayout_2->addWidget(peerDirection, 1, 1, 1, 1);
        ...
        gridLayout_2->addWidget(peerVersion, 2, 1, 1, 1);
        ...
        gridLayout_2->addWidget(peerSubversion, 3, 1, 1, 1);
        ...
        gridLayout_2->addWidget(peerServices, 4, 1, 1, 1);
        ...
        gridLayout_2->addWidget(peerHeight, 5, 1, 1, 1);
        ...
        gridLayout_2->addWidget(peerSyncHeight, 6, 1, 1, 1);
        ...
        gridLayout_2->addWidget(peerCommonHeight, 7, 1, 1, 1);
        ...
        gridLayout_2->addWidget(peerConnTime, 8, 1, 1, 1);
        ...
        gridLayout_2->addWidget(peerLastSend, 9, 1, 1, 1);
        ...
        gridLayout_2->addWidget(peerLastRecv, 10, 1, 1, 1);
        ...
        gridLayout_2->addWidget(peerBytesSent, 11, 1, 1, 1);
        ...
        gridLayout_2->addWidget(peerBytesRecv, 12, 1, 1, 1);
        ...
        gridLayout_2->addWidget(timeoffset, 16, 1, 1, 1);

        peerMappedASLabel = new QLabel(detailWidget);
        peerMappedASLabel->setObjectName(QStringLiteral("peerMappedASLabel"));

        gridLayout_2->addWidget(peerMappedASLabel, 17, 0, 1, 1);

        peerMappedAS = new QLabel(detailWidget);
        peerMappedAS->setObjectName(QStringLiteral("peerMappedAS"));
        ...
        gridLayout_2->addWidget(peerMappedAS, 17, 1, 1, 1);

        verticalSpacer_3 = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout_2->addItem(verticalSpacer_3, 18, 0, 1, 1);
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "Node window", 0));
        ...
        dataDir->setToolTip(QApplication::translate("RPCConsole", "To specify a non-default location of the data directory use the '%1' option.", 0));
#endif // QT_NO_TOOLTIP
        dataDir->setText(QApplication::translate("RPCConsole", "N/A", 0));
        label_11->setText(QApplication::translate("RPCConsole", "Blocksdir", 0));
#ifndef QT_NO_TOOLTIP
        blocksDir->setToolTip(QApplication::translate("RPCConsole", "To specify a non-default location of the blocks directory use the '%1' option.", 0));
#endif // QT_NO_TOOLTIP
        blocksDir->setText(QApplication::translate("RPCConsole", "N/A", 0));
        ...
        label_3->setText(QApplication::translate("RPCConsole", "Current block height", 0));
        ...
        WalletSelectorLabel->setText(QApplication::translate("RPCConsole", "Wallet: ", 0));
        WalletSelector->clear();
        WalletSelector->insertItems(0, QStringList()
         << QApplication::translate("RPCConsole", "(none)", 0)
        );
#ifndef QT_NO_TOOLTIP
        ...
        label_30->setText(QApplication::translate("RPCConsole", "Permissions", 0));
        peerPermissions->setText(QApplication::translate("RPCConsole", "N/A", 0));
...
#ifndef QT_NO_TOOLTIP
        peerMappedASLabel->setToolTip(QApplication::translate("RPCConsole", "The mapped Autonomous System used for diversifying peer selection.", 0));
#endif // QT_NO_TOOLTIP
        peerMappedASLabel->setText(QApplication::translate("RPCConsole", "Mapped AS", 0));
        peerMappedAS->setText(QApplication::translate("RPCConsole", "N/A", 0));

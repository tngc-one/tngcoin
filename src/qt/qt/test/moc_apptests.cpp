...
QT_MOC_LITERAL(4, 28, 26), // "TrustNetworkGlobalCoinGUI*"
QT_MOC_LITERAL(5, 55, 6), // "window"
QT_MOC_LITERAL(6, 62, 12), // "consoleTests"
QT_MOC_LITERAL(7, 75, 11), // "RPCConsole*"
QT_MOC_LITERAL(8, 87, 7) // "console"

    },
    "AppTests\0appTests\0\0guiTests\0"
    "TrustNetworkGlobalCoinGUI*\0window\0"
    "consoleTests\0RPCConsole*\0console"
};
...
void AppTests::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->guiTests((*reinterpret_cast< TrustNetworkGlobalCoinGUI*(*)>(_a[1]))); break;
...
const QMetaObject AppTests::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_AppTests.data,
      qt_meta_data_AppTests,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AppTests::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AppTests.stringdata0))
        return static_cast<void*>(const_cast< AppTests*>(this));

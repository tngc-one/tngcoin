...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<TrustNetworkGlobalCoinAmountField*>("payAmount")->setValue(amount);
...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_trustnetworkglobalcoin-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_trustnetworkglobalcoin-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_trustnetworkglobalcoin-qt  # macOS
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = TrustNetworkGlobalCoinUnits::formatWithUnit(unit, balance, false, TrustNetworkGlobalCoinUnits::SeparatorStyle::ALWAYS);
    ...
    // Amount input
    TrustNetworkGlobalCoinAmountField* amountInput = receiveCoinsDialog.findChild<TrustNetworkGlobalCoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QCOMPARE(uri.count("trustnetworkglobalcoin:"), 2);

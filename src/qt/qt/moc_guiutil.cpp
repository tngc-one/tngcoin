...
struct qt_meta_stringdata_GUIUtil__LabelOutOfFocusEventFilter_t {
    QByteArrayData data[1];
    char stringdata0[36];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_GUIUtil__LabelOutOfFocusEventFilter_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GUIUtil__LabelOutOfFocusEventFilter_t qt_meta_stringdata_GUIUtil__LabelOutOfFocusEventFilter = {
    {
QT_MOC_LITERAL(0, 0, 35) // "GUIUtil::LabelOutOfFocusEvent..."
...
void GUIUtil::LabelOutOfFocusEventFilter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject GUIUtil::LabelOutOfFocusEventFilter::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GUIUtil__LabelOutOfFocusEventFilter.data,
      qt_meta_data_GUIUtil__LabelOutOfFocusEventFilter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *GUIUtil::LabelOutOfFocusEventFilter::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *GUIUtil::LabelOutOfFocusEventFilter::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_GUIUtil__LabelOutOfFocusEventFilter.stringdata0))
        return static_cast<void*>(const_cast< LabelOutOfFocusEventFilter*>(this));
    return QObject::qt_metacast(_clname);
}

int GUIUtil::LabelOutOfFocusEventFilter::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QObject::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
...
void GUIUtil::ClickableProgressBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ClickableProgressBar::clicked)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject GUIUtil::ClickableProgressBar::staticMetaObject = {
    { &QProgressBar::staticMetaObject, qt_meta_stringdata_GUIUtil__ClickableProgressBar.data,
      qt_meta_data_GUIUtil__ClickableProgressBar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
struct qt_meta_stringdata_GUIUtil__ItemDelegate_t {
    QByteArrayData data[3];
    char stringdata0[40];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_GUIUtil__ItemDelegate_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GUIUtil__ItemDelegate_t qt_meta_stringdata_GUIUtil__ItemDelegate = {
    {
QT_MOC_LITERAL(0, 0, 21), // "GUIUtil::ItemDelegate"
QT_MOC_LITERAL(1, 22, 16), // "keyEscapePressed"
QT_MOC_LITERAL(2, 39, 0) // ""

    },
    "GUIUtil::ItemDelegate\0keyEscapePressed\0"
    ""
};
#undef QT_MOC_LITERAL
...
void GUIUtil::ItemDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ItemDelegate *_t = static_cast<ItemDelegate *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->keyEscapePressed(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (ItemDelegate::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ItemDelegate::keyEscapePressed)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject GUIUtil::ItemDelegate::staticMetaObject = {
    { &QItemDelegate::staticMetaObject, qt_meta_stringdata_GUIUtil__ItemDelegate.data,
      qt_meta_data_GUIUtil__ItemDelegate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *GUIUtil::ItemDelegate::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *GUIUtil::ItemDelegate::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_GUIUtil__ItemDelegate.stringdata0))
        return static_cast<void*>(const_cast< ItemDelegate*>(this));
    return QItemDelegate::qt_metacast(_clname);
}

int GUIUtil::ItemDelegate::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{

    ...
    platformStyle(_platformStyle)
{
    ...
    // normal trustnetworkglobalcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying trustnetworkglobalcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &TrustNetworkGlobalCoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
...
void SendCoinsEntry::clear()
{
    ...
    // update the display unit, to not use the default ("TNGC")
    updateDisplayUnit();
}

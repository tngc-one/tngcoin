...
#ifndef TRUSTNETWORKGLOBALCOIN_QT_PSBTOPERATIONSDIALOG_H
#define TRUSTNETWORKGLOBALCOIN_QT_PSBTOPERATIONSDIALOG_H
...
#endif // TRUSTNETWORKGLOBALCOIN_QT_PSBTOPERATIONSDIALOG_H

...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, TNGCGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &TNGCGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &TNGCGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &TNGCGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &TNGCGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &TNGCGUI::updateWalletStatus);
    connect(gui, &TNGCGUI::setPrivacy, walletView, &WalletView::setPrivacy);

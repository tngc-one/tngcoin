    ...
    platformStyle(_platformStyle)
{
    ...
    // normal tngc address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying tngc address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &TNGCAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);

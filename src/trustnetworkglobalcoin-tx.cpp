...
static void SetupTrustNetworkGlobalCoinTxArgs(ArgsManager &argsman)
{
...
{
    SetupTrustNetworkGlobalCoinTxArgs(gArgs);
    std::string error;
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " trustnetworkglobalcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  trustnetworkglobalcoin-tx [options] <hex-tx> [commands]  Update hex-encoded trustnetworkglobalcoin transaction\n" +
            "or:     trustnetworkglobalcoin-tx [options] -create [commands]   Create hex-encoded trustnetworkglobalcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded trustnetworkglobalcoin transaction

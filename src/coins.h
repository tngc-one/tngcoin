...
#ifndef TRUSTNETWORKGLOBALCOIN_COINS_H
#define TRUSTNETWORKGLOBALCOIN_COINS_H
 ...
 * between trustnetworkglobalcoind, and trustnetworkglobalcoin-qt and non-server tools.
 *
...
#endif // TRUSTNETWORKGLOBALCOIN_COINS_H

...
#ifndef TNGC_WALLET_SCRIPTPUBKEYMAN_H
#define TNGC_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The TNGC Core wallet was originally a collection of unrelated private
...
#endif // TNGC_WALLET_SCRIPTPUBKEYMAN_H

...
#ifndef TRUSTNETWORKGLOBALCOIN_WALLET_WALLETUTIL_H
#define TRUSTNETWORKGLOBALCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! trustnetworkglobalcoin from opening the wallet, thinking it was newly created, and
...
#endif // TRUSTNETWORKGLOBALCOIN_WALLET_WALLETUTIL_H

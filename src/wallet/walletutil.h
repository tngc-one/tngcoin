...
#ifndef TNGC_WALLET_WALLETUTIL_H
#define TNGC_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! tngc from opening the wallet, thinking it was newly created, and
...
#endif // TNGC_WALLET_WALLETUTIL_H

...
#ifndef TRUSTNETWORKGLOBALCOIN_WALLET_COINSELECTION_H
#define TRUSTNETWORKGLOBALCOIN_WALLET_COINSELECTION_H
...
#endif // TRUSTNETWORKGLOBALCOIN_WALLET_COINSELECTION_H

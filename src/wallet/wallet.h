...
#ifndef TRUSTNETWORKGLOBALCOIN_WALLET_WALLET_H
#define TRUSTNETWORKGLOBALCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this trustnetworkglobalcoin node, and set to 0 for transactions that were created
...
#endif // TRUSTNETWORKGLOBALCOIN_WALLET_WALLET_H

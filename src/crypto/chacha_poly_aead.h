...
#ifndef TNGC_CRYPTO_CHACHA_POLY_AEAD_H
#define TNGC_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@tngc.
 *
 ...
 *
 * The chacha20-poly1305@tngc combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@tngc cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@tngc are relatively fast in
...
#endif // TNGC_CRYPTO_CHACHA_POLY_AEAD_H

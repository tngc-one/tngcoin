...
#ifndef TRUSTNETWORKGLOBALCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define TRUSTNETWORKGLOBALCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@trustnetworkglobalcoin.
 *
 ...
 *
 * The chacha20-poly1305@trustnetworkglobalcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@trustnetworkglobalcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@trustnetworkglobalcoin are relatively fast in
...
#endif // TRUSTNETWORKGLOBALCOIN_CRYPTO_CHACHA_POLY_AEAD_H

...
#ifndef TRUSTNETWORKGLOBALCOIN_UTIL_BYTEVECTORHASH_H
#define TRUSTNETWORKGLOBALCOIN_UTIL_BYTEVECTORHASH_H
...
#endif // TRUSTNETWORKGLOBALCOIN_UTIL_BYTEVECTORHASH_H

...
#ifndef TRUSTNETWORKGLOBALCOIN_UTIL_MESSAGE_H
#define TRUSTNETWORKGLOBALCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's trustnetworkglobalcoin address, it must refer to a public key.
...
#endif // TRUSTNETWORKGLOBALCOIN_UTIL_MESSAGE_H

...
#ifndef TRUSTNETWORKGLOBALCOIN_UTIL_REF_H
#define TRUSTNETWORKGLOBALCOIN_UTIL_REF_H
 ...
 * (https://github.com/trustnetworkglobalcoin/trustnetworkglobalcoin/issues/16684)
 */
class Ref
{
public:
...
#endif // TRUSTNETWORKGLOBALCOIN_UTIL_REF_H

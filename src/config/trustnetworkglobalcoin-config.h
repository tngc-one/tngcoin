/* src/config/trustnetworkglobalcoin-config.h.  Generated from trustnetworkglobalcoin-config.h.in by configure.  */
/* src/config/trustnetworkglobalcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef TRUSTNETWORKGLOBALCOIN_CONFIG_H

#define TRUSTNETWORKGLOBALCOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The TrustNetworkGlobalCoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "TrustNetworkGlobalCoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/trustnetworkglobalcoin/trustnetworkglobalcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "TrustNetworkGlobalCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "TrustNetworkGlobalCoin Core 0.21.1rc1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "trustnetworkglobalcoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://trustnetworkglobalcoincore.org/"

/* Define to the version of this package. */
#define PACKAGE_VERSION "0.21.1rc1"
...
#endif //TRUSTNETWORKGLOBALCOIN_CONFIG_H

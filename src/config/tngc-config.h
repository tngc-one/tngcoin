/* src/config/tngc-config.h.  Generated from tngc-config.h.in by configure.  */
/* src/config/tngc-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef TNGC_CONFIG_H

#define TNGC_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The TNGC Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "TNGC Core"
...
#define PACKAGE_BUGREPORT "https://github.com/tngc/tngc/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "TNGC Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "TNGC Core 0.21.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "tngc"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://tngccore.org/"

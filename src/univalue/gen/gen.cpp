...
static void outputEscape()
{
	printf(	"// Automatically generated file. Do not modify.\n"
		"#ifndef TRUSTNETWORKGLOBALCOIN_UNIVALUE_UNIVALUE_ESCAPES_H\n"
		"#define TRUSTNETWORKGLOBALCOIN_UNIVALUE_UNIVALUE_ESCAPES_H\n"
	...
	printf(	"};\n"
		"#endif // TRUSTNETWORKGLOBALCOIN_UNIVALUE_UNIVALUE_ESCAPES_H\n");
}

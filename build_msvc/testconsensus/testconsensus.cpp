...
// tngc includes.
#include <..\src\script\tngcconsensus.h>
...
int main()
{
    std::cout << "tngcconsensus version: " << tngcconsensus_version() << std::endl;
    ...
    auto op0Result = tngcconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, tngcconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);

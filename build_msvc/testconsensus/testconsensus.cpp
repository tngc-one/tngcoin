...
// trustnetworkglobalcoin includes.
#include <..\src\script\trustnetworkglobalcoinconsensus.h>
...
int main()
{
    std::cout << "trustnetworkglobalcoinconsensus version: " << trustnetworkglobalcoinconsensus_version() << std::endl;
    ...
    auto op0Result = trustnetworkglobalcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, trustnetworkglobalcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
